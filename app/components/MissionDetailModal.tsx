...
export default function MissionDetailModal({
  ...
  // Calculate path from Warsaw (60%, 50%) to mission location
  const startTop = 60;
  const startLeft = 50;
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto min-h-0">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 h-full">
              {/* Left Column - Mission Location Map */}
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                {artwork && (
                  <div>
                    <h4 className="text-lg font-semibold text-amber-900 mb-2">Dzieło Sztuki</h4>
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-amber-700">{artwork.location}</p>
                    </div>
                  </div>
                )}
